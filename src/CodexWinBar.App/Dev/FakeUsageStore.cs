...
internal sealed class FakeUsageStore : IUsageStore
{
    ...
    private static ProviderState Codex(DateTimeOffset now) => new()
    {
        ...
        Snapshot = new UsageSnapshot
        {
            ...
            Identity = new ProviderIdentity { Plan = "pro", AccountEmail = "dev@example.com", LoginMethod = "OAuth" },
            UpdatedAt = now,
    ...
    private static ProviderState Cursor(DateTimeOffset now) => new()
    {
        ...
        Snapshot = new UsageSnapshot
        {
            ...
            Identity = new ProviderIdentity { Plan = "Pro", AccountEmail = "dev@example.com", LoginMethod = "Session cookie" },
            UpdatedAt = now,
            Confidence = DataConfidence.Exact,
        },
    };
